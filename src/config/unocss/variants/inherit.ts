...
export const variantInherit: Variant = {
  name: 'inherit',
  match(matcher, ctx) {
    const variant = variantGetBracket('inherit-', matcher, ctx.generator.config.separators)
...
export const variantWeakInherit: Variant = {
  name: 'weak-inherit',
  match(matcher, ctx) {
    const variant = variantGetBracket('weak-inherit-', matcher, ctx.generator.config.separators)
