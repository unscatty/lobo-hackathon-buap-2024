const Info = () => {
  return (
    <div className="max-w-screen mx-auto my-auto bg-black bg-opacity-40 pt-8 text-white ">
      <div className="w-7/8 h-full mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 ">
        ...
        <div className="p-10">
          <div>
            ...
            <div className="w-full h-full bg-white border border-radius-30"></div>
            <div className="w-full pb-4 pt-4 pl-4 rounded-lg flex items-center">
              <div className="bg-white w-15 h-13 m-4 border rounded-full flex justify-center items-center">
                <svg
            ...
            <div className="w-full pb-4 pt-4 pl-4 rounded-lg flex items-center">
              <div className="bg-white w-13 h-13 m-4 border rounded-full flex justify-center items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2em"
                  height="2em"
